...
The platform integrates a MySQL relational database for structured expression and annotation data with a Neo4j graph database for representing complex biological and clinical relationships. This dual-database architecture enables dynamic, phenotype-specific queries across plaque regions and cohorts. Secure user authentication, role-based access control, and an administrative interface support responsible data management and user oversight.
